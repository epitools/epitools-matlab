...
% Open button
pth1 = uipushtool(th,'CData',gif2cdata('images/gif/folder_page.gif'),...
    'TooltipString','Open a tracking file',...
    'HandleVisibility','off');

% Save button
pth2 = uipushtool(th,'CData',gif2cdata('images/gif/disk.gif'),...
...
tth5 = uitoggletool(th,'CData',gif2cdata('images/gif/table.gif'),'Separator','on',...
...
%     'ClickedCallback', {@keyPrsFcn,'h'});
% Grid toogle
tth8 = uitoggletool(th,'CData',gif2cdata('images/gif/grid.gif'),'Separator','on',...
    'TooltipString','Show/Hide grid on image',...
    'HandleVisibility','off',...
    'ClickedCallback', {@keyPrsFcn,'g'});

% Legend toogle
tth10 = uitoggletool(th,'CData',gif2cdata('images/gif/map.gif'),'Separator','on',...
...
% Inspect toogle
tth6 = uitoggletool(th,'CData',gif2cdata('images/gif/wand.gif'),'Separator','on',...
    'TooltipString','Inspect mode',...
    'HandleVisibility','off',...
    'ClickedCallback', {@keyPrsFcn,'i'});

% Final inspect toogle
tth7 = uitoggletool(th,'CData',gif2cdata('images/gif/monitor.gif'),'Separator','on',...
