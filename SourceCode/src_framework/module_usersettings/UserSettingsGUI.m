                ...
                case 'single'
                    ...
                    for o=1:numel(settingsobj.(root).(leaf).(char(nodes(i))).values)
                        uicontrol('Style','radiobutton',...
                                    ...
                                    'Units', 'normalized',...
                                    'Position',[0.01 (0.95-(0.04*o)) 0.2 0.04 ],...
                                    'Parent',h,...
                ...
                case 'multiple'
                    ...
                    for o=1:numel(settingsobj.(root).(leaf).(char(nodes(i))).values)
                        uicontrol('Style','checkbox',...
                                    ...
                                    'Value', settingsobj.(root).(leaf).(char(nodes(i))).actived(o),...
                                    'HandleVisibility','on',...
                                    'Callback',{@multselcbk,settingsobj,root,leaf,char(nodes(i)),o});
                    end
                ...
                case 'text'
                    h = uipanel('Title',settingsobj.(root).(leaf).(char(nodes(i))).name,'visible','on','Units', 'normalized','Position',[0 0 1 1], 'Parent',controlpanel);
                        ...
                        uicontrol('Style','text',...
                                    'Units', 'normalized',...
                                    'Position',[0.01 (0.95-(0.04)) 0.35 0.04 ],...
                                    'Parent',h,...
                                    'String', settingsobj.(root).(leaf).(char(nodes(i))).name);
                        uicontrol('Style','edit',...
                                    'Units', 'normalized',...
                                    'HorizontalAlignment', 'left',...
                                    'Position',[0.37 (0.95-(0.04)) 0.5 0.04 ],...
                                    'Parent',h,...
